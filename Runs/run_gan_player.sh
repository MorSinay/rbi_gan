...
CUDA_VISIBLE_DEVICES=1, python $loc/main.py --play --identifier=$identifier --resume=$resume --load-last-model --game=$game $args $aux &
CUDA_VISIBLE_DEVICES=2, python $loc/main.py --play --identifier=$identifier --resume=$resume --load-last-model --game=$game $args $aux &
CUDA_VISIBLE_DEVICES=3, python $loc/main.py --play --identifier=$identifier --resume=$resume --load-last-model --game=$game $args $aux &
